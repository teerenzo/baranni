...
class _AvailablePlacesScreenState extends ConsumerState<AvailablePlacesScreen>
  ...
  @override
  void initState() {
    controller = Get.put(PlacesController());
    super.initState();
  }
                  ...
                  children: [
                    ...
                    MyBreadcrumb(
                      children: [
                        ...
                        MyBreadcrumbItem(name: "Places", active: true),
                      ],
                    ),
                  ],
                ),
                ...
                children: [
                  ...
                  Expanded(
                    child: MyButton.block(
                      ...
                      borderRadiusAll: 4,
                      onPressed: () {
                        NavigatorHelper.pushNamed('/calendar');
                      },
    ...
    return Wrap(
      ...
      children: [
        ...
        MyContainer.roundBordered(
          ...
          // height: 36,
          onTap: () {
            controller.onSelectSize(5);
          },
          border: Border.all(
              color: controller.selectSize == 5
                  ? theme.colorScheme.primary
                  : theme.colorScheme.onBackground),
          color: controller.selectSize == 5 ? theme.colorScheme.primary : null,
          child: Center(
            child: MyText.bodySmall(
              "Queen",
              fontWeight: 600,
